          ...
          children: [
            ...
            GestureDetector(
              onTap: () async {
                ...
                //     context,
                //     MaterialPageRoute(
                //         builder: (context) => Shipment_subUser()));
              },
              child: Container(
                  decoration: BoxDecoration(
              ...
              GestureDetector(
                onTap: () async {
                  if (buttonstatus == "Deactivated") {
                    ...
                    var response =
                        await Providers().userDeactivated(receptionistId);
                    if (response.status == true) {
                      setState(() {
                        onTap = 1;
                        buttonstatus = "Reactivated";
                      });
                      showDialog(
                          context: context,
