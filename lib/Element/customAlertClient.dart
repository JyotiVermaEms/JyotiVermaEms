...
class ClientprofileConfirm extends StatefulWidget {
  var data;
  ClientprofileConfirm(this.data);

  @override
  _ClientprofileConfirm createState() => _ClientprofileConfirm();
}

class _ClientprofileConfirm extends State<ClientprofileConfirm>
    ...
    return Container(
        ...
        child: Column(
          children: [
            ...
            (Responsive.isDesktop(context))
                ? Center(
                    child: Align(
                        ...
                        child: Text("You have created a new account" +
                            " " +
            ...
            //             " " +
            //             "to Reset password before login"))),
            SizedBox(
            ...
            GestureDetector(
              onTap: () async {
                ...
                Navigator.of(context).pushReplacement(MaterialPageRoute(
                    builder: (BuildContext context) => ClinetSubUsers()));
                // Navigator.push(
                //     context,
                //     MaterialPageRoute(
...
//                       child: Stack(
//                         children: [
//                           widget.data['profileImage'].toString() == null
//                               ? Center(child: Icon(Icons.person))
//                               : ClipRRect(
//                                   borderRadius:
