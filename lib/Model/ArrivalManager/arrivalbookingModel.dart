class ArrivalBookingModel {
  ...
  late final List<ArrivalBookingData> data;

  ArrivalBookingModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    data = List.from(json['data'])
        .map((e) => ArrivalBookingData.fromJson(e))
        .toList();
  }
...
class ArrivalBookingData {
  ...
  ArrivalBookingData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    title = json['title'];
    uid = json['uid'];
...
//================================Arrival Marketplace order

class ArrivalMarketOrderModel {
  ArrivalMarketOrderModel({
    required this.status,
    required this.message,
    required this.data,
  });
  late final bool status;
  late final String message;
  late final List<ArrivalMArketData> data;

  ArrivalMarketOrderModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    data = List.from(json['data'])
        .map((e) => ArrivalMArketData.fromJson(e))
        .toList();
  }
...
class ArrivalMArketData {
  ...
  late final String cardType;
  late final List<ClientInfo> client;

  ArrivalMArketData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    title = json['title'];
    pickupLocation = json['pickup_location'];
    ...
    client =
        List.from(json['client']).map((e) => ClientInfo.fromJson(e)).toList();
  }
