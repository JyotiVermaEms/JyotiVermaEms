class ArrivalDashboardSearchModel {
  ArrivalDashboardSearchModel({
  ...
  late final List<searchArrivalData> data;

  ArrivalDashboardSearchModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    data = List.from(json['data'])
        .map((e) => searchArrivalData.fromJson(e))
        .toList();
  }
...
class searchArrivalData {
  ...
  searchArrivalData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    title = json['title'];
