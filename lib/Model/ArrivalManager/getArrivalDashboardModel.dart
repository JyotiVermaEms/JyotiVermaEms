// class ArrivalDashboardModel {
//   ArrivalDashboardModel({
...
//   late final List<ArrivalData> data;

//   ArrivalDashboardModel.fromJson(Map<String, dynamic> json) {
//     status = json['status'];
//     message = json['message'];
//     data = List.from(json['data']).map((e) => ArrivalData.fromJson(e)).toList();
//   }
