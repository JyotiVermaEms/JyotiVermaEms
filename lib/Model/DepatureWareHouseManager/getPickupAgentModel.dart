class PickupAgentListModel {
  PickupAgentListModel({
  ...
  late final List<ListData> data;

  PickupAgentListModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    data = List.from(json['data']).map((e) => ListData.fromJson(e)).toList();
  }
