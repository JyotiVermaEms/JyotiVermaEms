class PickupAgentDashboardModal {
  PickupAgentDashboardModal({
  ...
  late final List<PickupDashData> data;

  PickupAgentDashboardModal.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    data =
        List.from(json['data']).map((e) => PickupDashData.fromJson(e)).toList();
  }
...
class PickupDashData {
  ...
  PickupDashData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    title = json['title'];
    uid = json['uid'];
    ...
    shipmentId = json['shipmentId'] == null ? 0 : json['shipmentId'];
    arrival = json['arrival'] == null ? "" : json['arrival'];
    departure = json['departure'] == null ? "" : json['departure'];
...
//=================================== PickupAgnet market place order
class PickupMarketOrderModel {
  PickupMarketOrderModel({
    required this.status,
    required this.message,
    required this.data,
  });
  late final bool status;
  late final String message;
  late final List<PickupAgentMArketData> data;

  PickupMarketOrderModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    data = List.from(json['data'])
        .map((e) => PickupAgentMArketData.fromJson(e))
        .toList();
  }
...
class PickupAgentMArketData {
  PickupAgentMArketData({
    required this.id,
    required this.pickupAccept,
    required this.title,
    required this.pickupLocation,
  ...
  PickupAgentMArketData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    pickupAccept = json['pickup_accept'];
    title = json['title'];
    pickupLocation = json['pickup_location'];
