class PickupDashboardSearchStatusModel {
  PickupDashboardSearchStatusModel({
  ...
  late final List<PickupSearchStatusData> data;

  PickupDashboardSearchStatusModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    data = List.from(json['data'])
        .map((e) => PickupSearchStatusData.fromJson(e))
        .toList();
  }
...
class PickupSearchStatusData {
  PickupSearchStatusData({
    required this.id,
    required this.title,
    required this.uid,
  ...
  PickupSearchStatusData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    title = json['title'];
    uid = json['uid'];
