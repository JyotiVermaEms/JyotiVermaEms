...
//   late final List<ShipmentOrder> data;

//   ShipmentOrderModel.fromJson(Map<String, dynamic> json) {
//     status = json['status'];
//     message = json['message'];
//     data =
//         List.from(json['data']).map((e) => ShipmentOrder.fromJson(e)).toList();
//   }
...
//   ShipmentOrder.fromJson(Map<String, dynamic> json) {
//     id = json['id'];
