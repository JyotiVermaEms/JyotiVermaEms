class DepatureManagerListModel {
  DepatureManagerListModel({
  ...
  late final List<DepatureManagerDetais> data;

  DepatureManagerListModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    data = List.from(json['data'])
        .map((e) => DepatureManagerDetais.fromJson(e))
        .toList();
  }
...
class DepatureManagerDetais {
  DepatureManagerDetais({
    required this.id,
    required this.name,
    required this.lname,
    required this.email,
  ...
  DepatureManagerDetais.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    lname = json['lname'];
    email = json['email'];
