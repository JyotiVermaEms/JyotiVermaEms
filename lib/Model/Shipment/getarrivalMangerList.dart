class GetArrivalManagerListModel {
  GetArrivalManagerListModel({
  ...
  late final List<ArrivalManagerDetais> data;

  GetArrivalManagerListModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    data = List.from(json['data'])
        .map((e) => ArrivalManagerDetais.fromJson(e))
        .toList();
  }
...
class ArrivalManagerDetais {
  ArrivalManagerDetais({
    required this.id,
    required this.name,
    required this.lname,
    required this.email,
  ...
  ArrivalManagerDetais.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    lname = json['lname'];
    email = json['email'];
