...
class ArrivalProfile extends StatefulWidget {
  const ArrivalProfile({Key? key}) : super(key: key);

  @override
  _ArrivalProfileState createState() => _ArrivalProfileState();
}

class _ArrivalProfileState extends State<ArrivalProfile> {
  @override
