...
class PreReceptionistDashboard extends StatefulWidget {
  const PreReceptionistDashboard({Key? key}) : super(key: key);

  @override
  _PrePickupAgentDashboard createState() => _PrePickupAgentDashboard();
}

class _PrePickupAgentDashboard extends State<PreReceptionistDashboard> {
  @override
