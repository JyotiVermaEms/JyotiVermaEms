...
class AccountantSetting extends StatefulWidget {
  const AccountantSetting({Key? key}) : super(key: key);

  @override
  _AccountantSettingState createState() => _AccountantSettingState();
}

class _AccountantSettingState extends State<AccountantSetting> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(children: [
                        Container(
                          margin: EdgeInsets.only(right: 5, top: 70, left: 10),
                          child: Text(name,
                              style: TextStyle(
                                color: Colors.white,
                                fontWeight: FontWeight.bold,
