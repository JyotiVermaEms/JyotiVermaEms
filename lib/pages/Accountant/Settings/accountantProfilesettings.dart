...
import '../../../component/Accountant/Settings/Settings.dart';

class AccountantProfileSetting extends StatefulWidget {
  const AccountantProfileSetting({Key? key}) : super(key: key);

  @override
  _AccountantProfileSetting createState() => _AccountantProfileSetting();
}

class _AccountantProfileSetting extends State<AccountantProfileSetting> {
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Container(
                            margin: EdgeInsets.only(left: 15, top: 10),
                            child:
                                Text(name, style: headingStyle16NBLightGrey())),
                      ),
                    ],
                  )
                : Column(
    ...
    return GestureDetector(
      onTap: () {
        Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(builder: (context) => LoginScreen(roles: "2",)),
