...
class _CustomDialogBoxx extends State<CustomDialogBoxx> {
  ...
  Widget build(BuildContext context) {
    ...
    print("second google-----${widget.itemimage1}");
    print("second google comment-----${widget.comment1}");
    print("first girl-----${widget.depatureimage}");
    print("first i am depa-----${widget.depaturecomment}");
    print("second arrival image-----${widget.arrivalimage}");
    print("second arrival comment -----${widget.arrivalcomment}");
    return Dialog(
