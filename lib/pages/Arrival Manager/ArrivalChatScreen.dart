...
class ArrivalChatScreen extends StatefulWidget {
  const ArrivalChatScreen({Key? key}) : super(key: key);

  @override
  _ArrivalChatScreenState createState() => _ArrivalChatScreenState();
}

class _ArrivalChatScreenState extends State<ArrivalChatScreen> {
  ...
  searchList(name) async {
    ...
    var token = prefs.get("Arrival_Manager_token");
  ...
  void getShipProfileDetails() async {
    ...
    var userDetails = await Providers().getArrivalManagerProfile();
