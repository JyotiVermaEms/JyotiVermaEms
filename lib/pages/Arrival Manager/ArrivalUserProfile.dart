...
import '../../component/Arrival Manager/Profile.dart';
import 'package:http/http.dart' as http;

class ArrivalUserProfile extends StatefulWidget {
  const ArrivalUserProfile({Key? key}) : super(key: key);

  @override
  _ArrivalUserProfileState createState() => _ArrivalUserProfileState();
}

class _ArrivalUserProfileState extends State<ArrivalUserProfile> {
            ...
            children: [
              ...
              Align(
                ...
                child: Container(
                    margin: EdgeInsets.only(left: 15, top: 10),
                    child:
                        Text("LastName", style: headingStyle16NBLightGrey())),
              ),
              Align(
                alignment: Alignment.topLeft,
                child: Container(
