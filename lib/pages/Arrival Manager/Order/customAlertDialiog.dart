...
class CustomDialogBoxx extends StatefulWidget {
  ...
  @override
  _CustomDialogBoxx createState() => _CustomDialogBoxx();
}

class _CustomDialogBoxx extends State<CustomDialogBoxx> {
  // List image = [];
  ...
  doChangeMarketStatus() async {
    ...
    var response = await Providers().changeMrketArrivalStatus(depatureData);
    if (response.status == true) {
      Navigator.pop(context);
      showDialog(
          context: context,
        ...
        child: ListView(
          children: [
            Row(children: [
              ...
              SizedBox(
                width: (Responsive.isDesktop(context)) ? 290 : 20,
              ),
              InkWell(
                onTap: () {
                  Navigator.of(context).pop();
                ...
                child: Align(
                  ...
                  child: Padding(
                    padding: EdgeInsets.only(
                        left: (Responsive.isDesktop(context)) ? 370 : 10),
                    child: Container(
                      decoration: BoxDecoration(
                          border: Border.all(color: Colors.black)),
                      height: 20,
            ...
            Container(
              height: (Responsive.isDesktop(context)) ? 100 : 157,
                                  ...
                                  ? Column(
                                      children: [
                                        ...
                                        Container(
                                            ...
                                            margin: EdgeInsets.only(left: 10),
                                            child: Text(
                                              "Delivered to DepartureWarehouse",
                                              style: TextStyle(
                                                  fontSize: 10,
                                                  fontWeight: FontWeight.bold),
                                            )),
            ...
            (widget.status == "pickup item received")
                ...
                ? Padding(
                    ...
                    child: Stack(children: [
                      ...
                      Positioned(
                        left: (Responsive.isDesktop(context)) ? 480.0 : w * 0.4,
                        child: IconButton(
                          onPressed: () {
                            setState(() {
                              imagepath = "";
