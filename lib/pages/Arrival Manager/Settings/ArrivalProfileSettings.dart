...
class ArrivalProfileSetting extends StatefulWidget {
  const ArrivalProfileSetting({Key? key}) : super(key: key);

  @override
  _ArrivalProfileSetting createState() => _ArrivalProfileSetting();
}

class _ArrivalProfileSetting extends State<ArrivalProfileSetting> {
