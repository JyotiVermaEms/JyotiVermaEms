...
import 'package:shipment/pages/Client/Chat/clientChatPage.dart';
import 'package:websafe_svg/websafe_svg.dart';
import '../../../constants.dart';
import 'package:flutter/foundation.dart' show kIsWeb;

class ClientChatScreen extends StatefulWidget {
  ClientChatScreen(data);
                          ...
                          return Padding(
                            ...
                            child: InkWell(
                              onTap: () async {
                                ...
                                data11 = {
                                  "group_name": chatListResponse![index]
                                      .groupName
                                      .toString(),
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                              child: Text.rich(
                                                TextSpan(
                                                  text:
                                                      "${chatListResponse![index].groupName} \n",
                                                  style: TextStyle(
                                                    fontSize: 16,
