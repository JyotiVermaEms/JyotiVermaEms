// ignore_for_file: prefer_const_constructors, duplicate_ignore, prefer_const_literals_to_create_immutables, dead_code
...
class _UpdatePasswordState extends State<UpdatePassword> {
  ...
  //   var update = await APIFunctions().updatepassword(updatedata);

  //   if (update.status == true) {
  //     ScaffoldMessenger.of(context)
  //         .showSnackBar(SnackBar(content: Text(update.message)));
  //     Navigator.push(
  //         context, MaterialPageRoute(builder: (context) => ResetConfirm()));
  //   } else {
  //     ScaffoldMessenger.of(context)
  //         .showSnackBar(SnackBar(content: Text(update.message)));
  //   }
