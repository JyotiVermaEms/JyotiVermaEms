...
import 'package:shipment/component/Res_Client/ResMarketPlace/Res_Booking_Requirement.dart';
import 'package:shipment/constants.dart';

import 'package:flutter/foundation.dart' show kIsWeb;

class BookinDescription extends StatefulWidget {
  var data;
  BookinDescription(this.data);
  // const BookinDescription({Key? key}) : super(key: key);

  @override
  _BookinDescriptionState createState() => _BookinDescriptionState();
}

class _BookinDescriptionState extends State<BookinDescription> {
          ...
          onTap: () {
            if (_formKey.currentState!.validate()) {
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => ResBookingRequirement(data)));
            }
          },
          child: Row(children: [
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      //       return "should be required min 120 characters";
                      //     }
                      //   },
                      //   style: TextStyle(color: Colors.black, fontSize: 14),
                      //   decoration: InputDecoration(
