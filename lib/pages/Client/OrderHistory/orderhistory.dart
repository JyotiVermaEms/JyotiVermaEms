...
class BookingOrderHistory extends StatefulWidget {
  const BookingOrderHistory({Key? key}) : super(key: key);

  @override
  _BookingOrderHistoryState createState() => _BookingOrderHistoryState();
}

class _BookingOrderHistoryState extends State<BookingOrderHistory> {
  ...
  getView() async {
    ...
    log('view booking ${json.encode(response)}');
  ...
  Widget orderDetails() {
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          return viewbooking[index].status == "received by receptionist"
              ? Container(
                  // height: (!Responsive.isDesktop(context))
                  //     ? MediaQuery.of(context).size.height * (10 / 100)
                  //     : MediaQuery.of(context).size.height * (45 / 100),
                  ...
                  child: Row(children: [
                    ...
                    InkWell(
                      onTap: () {
                        var sid = viewbooking[index].sid.toString();
                        var companyName =
                            ...
                            Container(
                                ...
                                child: Text(
                                    (DateFormat('dd-MM-yyyy').format(
                                        DateTime.parse(viewbooking[index]
                                            .createdAt
                                            .toString()))),
                                    style: TextStyle(
                                        fontWeight: FontWeight.bold))),
