...
import '../../../Model/DepatureWareHouseManager/depatureordermodel.dart';
import '../../../constants.dart';

import 'package:flutter/foundation.dart' show kIsWeb;

class DepartureClientBookingShow extends StatefulWidget {
  var bookingdata;
  DepartureClientBookingShow(this.bookingdata);

  @override
  _DepartureClientBookingShow createState() => _DepartureClientBookingShow();
}

class _DepartureClientBookingShow extends State<DepartureClientBookingShow>
                                        ...
                                        ? showDialog(
                                            ...
                                            builder: (BuildContext context) {
                                              return AlertDialog(
                                                title: Text("Confirm"),
                                                content: Text(
                                                    "Are you sure you want to inprogress this schedule?"),
                                                actions: [
                                                  InkWell(
                                                    child: Text("No          "),
                                                    onTap: () {
                  ...
                  Container(
                      ...
                      child: Text(
                        (widget.bookingdata['bookinglength'])[index]
                            .bookingType
                            .toString(),
                        // widget.bookingdata['bookinglength'][index].bookingType
                        //     .toString(),
                        // widget.bookingdata['type'].toString(),
                        style: TextStyle(fontWeight: FontWeight.bold),
                      )),
                  Container(
                      width: w * 0.06,
