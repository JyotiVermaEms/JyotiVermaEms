...
import '../../component/Pickup Agent/Profile/Profile.dart';

class PickupProfile extends StatefulWidget {
  const PickupProfile({Key? key}) : super(key: key);

  @override
  _PickupProfileState createState() => _PickupProfileState();
}

class _PickupProfileState extends State<PickupProfile> {
  ...
  Widget container_client() {
    return Container(
      height: h,
      width: (Responsive.isDesktop(context)) ? w * 0.72 : w * 0.9,
      child: Container(
          ...
          child: ListView(
            ...
            children: [
              ...
              Container(
                ...
                //   suggestions:
                //       _languages.map((e) => SearchFieldListItem(e)).toList(),
                ...
                //   ),
                //   validator: (x) {
                //     if (!_languages.contains(x) || x!.isEmpty) {
                //       return 'required';
                //     }
                //     return null;
                //   },
                ...
                //   onSubmit: (x) {
                //     // print("-=-=-= ${x.searchKey}");
                //     // this.controller.text = x.searchKey.toString();
                //     languages = this.controller.text;
                //   },
                // ),
              ),
              ...
              Align(
                ...
                child: Container(
                  margin: EdgeInsets.only(left: 15, top: 10),
                  child: Text("About Me", style: headingStyle16NBLightGrey()),
                ),
              ),
              Align(
                alignment: Alignment.topLeft,
