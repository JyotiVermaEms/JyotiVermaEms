...
class ReceptionistNotificationScreen extends StatefulWidget {
  static const String route = '/';
  const ReceptionistNotificationScreen({Key? key}) : super(key: key);

  @override
  _ReceptionistNotificationScreen createState() =>
      _ReceptionistNotificationScreen();
}

class _ReceptionistNotificationScreen
    extends State<ReceptionistNotificationScreen> {
  @override
  Widget build(BuildContext context) {
    Size _size = MediaQuery.of(context).size;
    return Scaffold(
      body: Responsive(
        mobile: ReceptionistNotificationShow(),
        tablet: ReceptionistNotificationShow(),
        desktop: Row(
          children: [
            ...
            Expanded(
              ...
              child: ReceptionistNotificationShow(),
            ),
            // Expanded(
...
class ReceptionistNotificationShow extends StatefulWidget {
  ReceptionistNotificationShow();
  // const ClientReview({Key? key}) : super(key: key);

  @override
  _ReceptionistNotificationShow createState() =>
      _ReceptionistNotificationShow();
}

class _ReceptionistNotificationShow
    extends State<ReceptionistNotificationShow> {
  ...
  getSubPanelNotificationList() async {
    ...
    var shipmentauthToken = prefs.getString('receptionist_token');
    print("Token $shipmentauthToken");
    var response =
        await Providers().getClientSubPanelNotification(shipmentauthToken);
  ...
  getSubPanelClearNotificationList() async {
    ...
    print("Token $shipmentauthToken");
    var response =
        await Providers().getClientSubPanelClearNotification(shipmentauthToken);

    if (response.status == true) {
      Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => ReceptionistNotificationScreen()),
      );
    }
  }
