...
class CustomDialogBoxShipment extends StatefulWidget {
  var id;
  ...
  @override
  _CustomDialogBoxShipment createState() => _CustomDialogBoxShipment();
}

class _CustomDialogBoxShipment extends State<CustomDialogBoxShipment> {
                  ...
                  child: widget.receptionistimage != null
                      ? Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              color: Colors.white,
                              borderRadius: BorderRadius.circular(5)),
                          height: (Responsive.isDesktop(context)) ? 250 : 100,
