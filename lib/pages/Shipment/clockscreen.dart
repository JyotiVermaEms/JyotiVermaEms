...
class _OrderRecievedState extends State<OrderRecieved>
  ...
  Widget thirdRow(int index) {
    Duration duration = Duration(days: 1, hours: 24, minutes: 1440);
    Timer? timer;
                    ...
                    return Container(
                      ...
                      child: AlertDialog(
                        ...
                        content: StatefulBuilder(builder:
                          ...
                          var splitDate = brdata![index].createdAt.split("T");
                          var secSplit =
                              splitDate[1].replaceAll("Z", '').split(".");

                          DateTime dateTimeCreatedAt =
                              DateTime.parse(splitDate[0] + ' ' + secSplit[0]);
                          log(dateTimeCreatedAt
                              .toString()); //2022-04-09 00:00:00.000
                          DateTime dateTimeNow = DateTime.now();
                          log(dateTimeNow.toString()); //2022-04-09 15:04:26.612

                          final differenceInDays =
                              dateTimeNow.difference(dateTimeCreatedAt).inDays;
                          print('-=-=-=-=- $differenceInDays');

                          DateTime dt1 = DateTime.parse(dateTimeNow.toString());
                          DateTime dt2 =
                              DateTime.parse(dateTimeCreatedAt.toString());
                    ...
                    return Container(
                      ...
                      child: AlertDialog(
                        ...
                        content: StatefulBuilder(builder:
                          ...
                          _setState(() {
                            // hours = strDigits(diff.inHours);
                            // minutes = strDigits(diff.inMinutes);
                            // seconds = strDigits(diff.inSeconds);
                            duration = Duration(
                                days: diff.inDays,
                                hours: diff.inHours,
                                minutes: diff.inMinutes,
